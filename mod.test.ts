...
Deno.test("False 1", { permissions: "none" }, () => {
	deepStrictEqual(isStringSingleLine(`Wisi sed et at vero eos nostrud volutpat sed stet dignissim sit sanctus in eros.
...
Deno.test("True 1", { permissions: "none" }, () => {
	deepStrictEqual(isStringSingleLine("Hello, world!"), true);
});
